package com.wtowto7207.natimage;
...
public class Natimage extends WXModule {

    private JSCallback mPickCallback;
    private HashMap<String, Object> mPickParam;

    private JSCallback mPreviewCallback;
    private String[] mFiles;
    private HashMap<String, Object> mPreviewParam;

    private static final int PICK_REQUEST_CODE = 101;
    private static final int PREVIEW_REQUEST_CODE = 102;

    private String lang = Locale.getDefault().getLanguage();
    private Boolean isChinese = lang.startsWith("zh");
